...
const DEFAULT_PLANS = [
  ...
  { id: 'style', name: 'Style Pack', price: 1500, credits: 10, description: 'Ten try-on sessions' },
  { id: 'studio', name: 'Studio Pack', price: 6000, credits: 50, description: 'Fifty client try-on sessions' }
];
